...
const BASE_DE_DATOS_PROYECCION = [
  ...
  { nombre: "MERLY MENDEZ HURTADO", colAct: 0, dias: [0,0,30480,0,0,0,0], proy: [1,0,0,0,0,0,0] }, 
  { nombre: "RODRIGO ROJAS SILES", colAct: 0, dias: [0,0,0,0,17280,0,0], proy: [0,0,0,0,0,0,0] },
