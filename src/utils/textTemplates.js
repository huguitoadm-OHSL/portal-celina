import { formatCurrency, formatDiaMes } from './formatters';

export const generarTextoRecompraCelular = (formRecompra, beneficio) => {
...
export const generarTextoDescuentoCelular = (formDescuento, calculos) => {
...
export const generarTextoSeguroCelular = (formSeguro) => {
...
export const generarTextoFisicoCelular = (formFisico) => {
...
export const generarTextoReenvioCelular = (formReenvio) => {
  let lista = "";
...
export const generarTextoDiariaCelular = (formDiaria) => {
