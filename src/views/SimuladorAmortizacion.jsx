                ...
                <div className="animate-in fade-in duration-300">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                    ...
                    <div className="md:col-span-2 bg-gradient-to-br from-emerald-600 to-teal-800 rounded-2xl p-4 md:p-6 text-white shadow-xl relative overflow-hidden flex flex-col justify-center transform transition-transform hover:scale-[1.01]">
                        ...
                        <h3 className="text-[9px] md:text-[11px] text-emerald-100 font-black uppercase tracking-widest mb-1 md:mb-2">Impacto Total del Abono Extraordinario</h3>
                        <div className="flex flex-col md:flex-row md:items-end gap-1 md:gap-4 mb-3 md:mb-4">
